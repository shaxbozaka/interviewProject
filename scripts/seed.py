...
BOOKS = [
    ...
    ('Designing Data-Intensive Applications', 'Martin Kleppmann', 'technology', '9781449373320'),
    ...
    ('Harry Potter and the Chamber of Secrets', 'J.K. Rowling', 'fantasy', '9780439064873'),
            ...
            _, created = Rating.objects.get_or_create(
                ...
                defaults={
                    ...
                    'review': random.choice([
                        ...
                        'Interesting read.', 'Could be better.',
                        'A classic.', '',
                    ]),
                },
            )
