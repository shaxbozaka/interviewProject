...
class TestNotificationStrategies:
    ...
    def test_email_strategy_sends(self):
        user = User.objects.create_user(
            username='notify_user', password='pass12345678',
...
class TestNotificationTasks:
    def test_send_reservation_confirmation(self):
        user = User.objects.create_user(
            username='task_user', password='pass12345678',
    ...
    def test_check_overdue_reservations(self):
        ...
        user = User.objects.create_user(
            username='overdue_user', password='pass12345678',
            email='overdue@example.com',
        )
        book = Book.objects.create(
            title='Overdue Book', author='Author',
            publication_date='2024-01-01',
            copies_available=3, copies_total=3,
        )
