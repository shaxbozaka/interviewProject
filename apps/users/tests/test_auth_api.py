...
class TestPermissions:
    def test_member_cannot_access_librarian_endpoint(self, api_client):
        ...
        user = User.objects.create_user(username='member', password='pass12345678', role='member')
        assert user.role == 'member'

    def test_librarian_role_assignment(self, api_client):
        user = User.objects.create_user(username='librarian', password='pass12345678', role='librarian')
