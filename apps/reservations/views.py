...
class ReservationViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        trace_step(
            f'ReservationViewSet.perform_create() book={book.id} "{book.title}"',
            "logic",
        )
    ...
    def return_book(self, request, pk=None):
        ...
        trace_step(
            f"ReservationViewSet.return_book() reservation={reservation.id}", "logic"
        )
    ...
    def extend(self, request, pk=None):
        ...
        trace_step(
            f"ReservationViewSet.extend() reservation={reservation.id} +{days}d",
            "logic",
        )
