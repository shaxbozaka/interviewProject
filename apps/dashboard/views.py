    ...
    return Response(
        {
            ...
            "design_patterns": [
                {
                    "name": "Repository",
                    "location": "apps/books/services.py",
                    "purpose": "Data access abstraction with caching",
                },
                {
                    "name": "Command",
                    "location": "apps/reservations/commands.py",
                    "purpose": "ReserveBook, ReturnBook, ExtendReservation",
                },
                {
                    "name": "Factory + Strategy",
                    "location": "apps/notifications/",
                    "purpose": "Polymorphic notification channels",
                },
                {
                    "name": "Circuit Breaker",
                    "location": "core/resilience.py",
                    "purpose": "CLOSED/OPEN/HALF_OPEN fault tolerance",
                },
                {
                    "name": "Retry with Backoff",
                    "location": "core/resilience.py",
                    "purpose": "Exponential backoff + jitter",
                },
                {
                    "name": "CQRS",
                    "location": "apps/analytics/",
                    "purpose": "Denormalized read model via Kafka",
                },
            ],
            "custom_dsa": [
                {
                    ...
                    "description": "Doubly-linked list + hashmap, O(1) ops, TTL, thread-safe",
                },
                {
                    "name": "Two-Tier Cache",
                    "location": "core/caching.py",
                    "description": "L1 in-process LRU + L2 Redis with pattern invalidation",
                },
                {
                    "name": "Trie",
                    "location": "core/trie.py",
                    "description": "Prefix tree for autocomplete, weight-based ranking",
                },
                {
                    "name": "Token Bucket",
                    "location": "core/rate_limiter.py",
                    "description": "Per-client rate limiting with stale bucket cleanup",
                },
            ],
            "services": [
                "Django/Gunicorn",
    ...
    result = {
        ...
        "manifests": {
            ...
            "deployments": [
                {
                    "name": "web",
                    "replicas": 3,
                    "image": "library-web:latest",
                    "hpa": {"min": 2, "max": 10, "cpu_target": 70, "memory_target": 80},
                },
                {
                    "name": "celery",
                    "replicas": 2,
                    "image": "library-web:latest",
                    "queues": ["default", "notifications", "analytics"],
                },
            ...
            "jobs": [
                ...
                {
                    "name": "db-seed",
                    "command": "python scripts/seed_massive.py",
                    "records": "90K+",
                },
                ...
                "pods": [
                    {
                        ...
                        "started": p.status.start_time.isoformat()
